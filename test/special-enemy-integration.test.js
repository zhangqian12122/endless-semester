...
test("特殊敌人机制牌接入战场并在结算期间冻结刚刚执行的步骤", () => {
  ...
  assert.match(appSource, /class="enemy-mechanic-progress kind-\$\{escapeHtml\(enemy\.id\)\}"/);
