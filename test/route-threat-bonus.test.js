...
test("地图、战斗、复盘与领奖页连续公开同一份高威胁奖励承诺", () => {
  ...
  assert.match(appSource, /route-threat-payout/, "战后复盘必须公开奖金拆分");
  ...
  assert.match(styleSource, /\.route-threat-payout\b/);
  ...
  assert.equal(styleVersion, "1.8.48", "风险收益界面上线时必须提升缓存版本");
});
